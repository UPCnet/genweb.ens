...
from genweb.ens.ws_client.indicators import (
...
''')
    ...
    def test_list_indicators(self):
        ...
        # Connection error
        with patch('genweb.ens.ws_client.indicators.requests.get',
        ...
        with patch('genweb.ens.ws_client.indicators.requests.get',
                ...
                'genweb.ens.ws_client.indicators.Client._parse_response_list_indicators',
                side_effect=([],)):
    ...
    def test_list_categories(self):
        ...
        with patch('genweb.ens.ws_client.indicators.requests.get',
                   side_effect=(response_mock,)), patch(
                'genweb.ens.ws_client.indicators.Client._parse_response_list_categories',
                side_effect=([],)):
